...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('engineer.resource-requests.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @forelse($allRequests ?? [] as $request)
                                    <tr>
                                        ...
                                        <td>{{ isset($request->project) && is_object($request->project) ? $request->project->name : 'N/A' }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('engineer.resource-requests.show', $request) }}" class="btn btn-sm btn-primary">

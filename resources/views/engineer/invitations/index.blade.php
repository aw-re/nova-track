                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <form action="{{ route('engineer.invitations.accept', $invitation) }}" method="POST" class="d-inline">
                                                    @csrf
                                                ...
                                                <form action="{{ route('engineer.invitations.reject', $invitation) }}" method="POST" class="d-inline ms-1">
                                                    @csrf

...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('engineer.files.download', $file) }}" class="btn btn-success">
                <i class="fas fa-download"></i> Download
            </a>
            @if($file->user_id == auth()->id())
                <form action="{{ route('engineer.files.destroy', $file) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this file?');">
                    @csrf
                    @method('DELETE')
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            ...
                            @elseif($file->resource_request_id)
            ...
            @if(in_array(strtolower($file->extension), ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
                <div class="card mb-4">
                    ...
                    <div class="card-body text-center">
                        <img src="{{ route('engineer.files.preview', $file) }}" alt="{{ $file->name }}" class="img-fluid" style="max-height: 500px;">
                    </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('engineer.files.comment', $file) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="text-muted">{{ date('M d, Y h:i A', strtotime($download->created_at)) }}</div>
                                    </div>

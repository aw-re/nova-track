...
@section('sidebar')
    ...
    <li class="nav-item">
        <a class="nav-link active" href="{{ route('engineer.files.index') }}">
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('engineer.files.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div id="report_selection" class="mb-3 d-none">
                    <label for="report_id" class="form-label">Select Report <span class="text-danger">*</span></label>
                ...
                <div id="resource_request_selection" class="mb-3 d-none">
                    <label for="resource_request_id" class="form-label">Select Resource Request <span class="text-danger">*</span></label>
                    <select class="form-select @error('resource_request_id') is-invalid @enderror" id="resource_request_id" name="resource_request_id">
                    ...
                    @error('resource_request_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                
                <div class="d-flex justify-content-end">
                    <a href="{{ route('engineer.files.index') }}" class="btn btn-secondary me-2">Cancel</a>
...
@section('scripts')
    <script>
        ...
        document.getElementById('related_to').addEventListener('change', function() {
            ...
            document.getElementById('report_selection').classList.add('d-none');
            document.getElementById('resource_request_selection').classList.add('d-none');
            ...
            } else if (relatedTo === 'report') {
                document.getElementById('report_selection').classList.remove('d-none');
            } else if (relatedTo === 'resource_request') {
                document.getElementById('resource_request_selection').classList.remove('d-none');
            }
        });

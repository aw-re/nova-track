...
class FileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('engineer.files.index', compact('files'));
    }
    ...
    public function create()
    {
        ...
        return view('engineer.files.create', compact('projects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$isMember) {
            return redirect()->route('engineer.files.create')
        ...
        return redirect()->route('engineer.files.index')
    ...
    {
        // Check if the engineer is a member of the project
        ...
        return view('engineer.files.show', compact('file'));
    }
    ...
    {
        // Check if the engineer is a member of the project and uploaded the file
        $isMember = $file->project->members()->where('user_id', Auth::id())->exists();
        ...
        return view('engineer.files.edit', compact('file', 'projects'));
    }
    ...
    public function update(Request $request, File $file)
    {
        ...
        // Verify the engineer is a member of the new project
        $isMember = Project::find($request->project_id)
            ->members()
            ->where('user_id', Auth::id())
            ->exists();
        ...
        if (!$isMember) {
            return redirect()->route('engineer.files.edit', $file)
                ->with('error', 'You are not a member of this project.');
        }

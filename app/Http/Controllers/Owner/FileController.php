...
class FileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('owner.files.index', compact('files'));
    }
    ...
    public function create()
    {
        ...
        return view('owner.files.create', compact('projects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($project->owner_id !== Auth::id()) {
            return redirect()->route('owner.files.create')
        ...
        return redirect()->route('owner.files.index')
    ...
    {
        // Check if the file belongs to a project owned by the user
        if ($file->project->owner_id !== Auth::id()) {
            return redirect()->route('owner.files.index')
                ->with('error', 'You do not have permission to view this file.');
        }

        $file->load(['project', 'uploadedBy']);
        return view('owner.files.show', compact('file'));
    }
    ...
    public function edit(File $file)
    {
        ...
        $projects = Project::where('owner_id', Auth::id())->get();
        return view('owner.files.edit', compact('file', 'projects'));
    }
    ...
    public function update(Request $request, File $file)
    {
        ...
        $project = Project::findOrFail($request->project_id);
        if ($project->owner_id !== Auth::id()) {
            return redirect()->route('owner.files.edit', $file)
                ->with('error', 'You do not have permission to move files to this project.');
        }
